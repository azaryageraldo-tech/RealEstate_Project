    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('agent.properties.create') }}"
                class="px-6 py-2 bg-gradient-to-r from-blue-600 to-blue-800 text-white font-bold rounded-lg shadow-lg transform hover:scale-105 transition-all">
                Tambah Properti
            </a>
        </div>
    </x-slot>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left">
                    ...
                    <tbody>
                            ...
                            <tr class="border-b last:border-b-0 hover:bg-slate-50">
                                <td class="p-4">
                                    <a href="{{ route('agent.properties.show', $property) }}"
                                        ...
                                        <img src="{{ Storage::url($property->image_url) }}" alt="{{ $property->name }}"
                                ...
                                <td class="p-4">
                                    <span @class([
                                        ...
                                        'bg-yellow-100 text-yellow-800' => $property->status == 'Menunggu Review', // <-- Tambahkan ini
                                ...
                                <td class="p-4 text-gray-700 font-semibold">Rp {{ number_format($property->price) }}
                                </td>
                                ...
                                <td class="p-4">
                                    <div class="flex gap-2">
                                        ...
                                        <a href="{{ route('agent.properties.edit', $property) }}"
                                            class="px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-xs font-semibold flex items-center gap-1 hover:bg-blue-200 transition">
                                        ...
                                        <form action="{{ route('agent.properties.destroy', $property) }}"
                                            ...
                                            @method('DELETE')
                                            <button type="submit"
                                                class="px-3 py-1 bg-red-100 text-red-700 rounded-full text-xs font-semibold flex items-center gap-1 hover:bg-red-200 transition">
                                                <svg class="w-3 h-3" fill="none" stroke="currentColor"
                                                    viewBox="0 0 24 24">
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="p-8 text-center text-gray-500">Anda belum memiliki listing.
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
