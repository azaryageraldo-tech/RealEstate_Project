        ...
        <div class="mt-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div data-aos="fade-up" data-aos-delay="{{ ($index + 1) * 100 }}" class="group bg-white rounded-xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-2xl hover:-translate-y-2">
                    <div class="relative">
                        <a href="{{ route('properti.show', $property) }}">
                            <img src="{{ Storage::url($property->image_url) }}" alt="{{ $property->name }}" class="w-full h-64 object-cover transition-transform duration-300 group-hover:scale-105">
                        </a>
            ...
            @empty
                <div class="col-span-3 text-center py-12">
                    <p class="text-gray-500">Saat ini belum ada properti pilihan yang tersedia.</p>
                </div>
            @endforelse
