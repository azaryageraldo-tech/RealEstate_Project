@php
// Ini akan mengambil nama route yang sedang aktif, contoh: 'agent.dashboard'
...
<aside class="w-64 bg-slate-800 text-white flex flex-col flex-shrink-0">
    ...
    <nav class="mt-8 flex-grow">
        ...
        <a href="{{ route('agent.properties.index') }}" @class([
            'flex items-center gap-4 px-6 py-4 transition',
            // Gunakan str_contains untuk membuat menu ini aktif di semua halaman properti
    ...
    <div class="p-6 border-t border-slate-700">
        <a href="{{ route('profile.edit') }}" class="flex items-center gap-4 group">
            <img class="w-10 h-10 rounded-full object-cover" src="https://i.pravatar.cc/150?u={{ Auth::id() }}" alt="Avatar">
            <div class="flex-grow">
